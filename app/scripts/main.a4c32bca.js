...
var AppHome = function AppHome(_ref) {
  ...
  var _useState13 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
    ...
    convFreq = _useState14[0],
    setConvFreq = _useState14[1]; // State for dynamic ticket data
  var _useState15 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(""),
    _useState16 = _slicedToArray(_useState15, 2),
    url = _useState16[0],
    setUrl = _useState16[1]; // State for dynamic ticket data
  var _useState17 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false),
    _useState18 = _slicedToArray(_useState17, 2),
    emailNotFound = _useState18[0],
    setEmailNotFound = _useState18[1];
  ...
  var _useState21 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)({}),
    ...
    issues = _useState22[0],
    setIssues = _useState22[1]; // Store all issues
  var _useState23 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)({
      id: "",
      text: ""
    }),
    _useState24 = _slicedToArray(_useState23, 2),
    firstIssue = _useState24[0],
    setFirstIssue = _useState24[1];
  ...
  var _useState25 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
    ...
    chartData = _useState26[0],
    setChartData = _useState26[1];
  var _useState27 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(),
    _useState28 = _slicedToArray(_useState27, 2),
    typeFrom = _useState28[0],
    setTypeFrom = _useState28[1];
  var iconDataSource = [{
    id: "bar",
    name: "BarChart"
  }, {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    var fetchConvData = /*#__PURE__*/function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        var _client$request2, response, data, formattedData, issueDataMap, firstIssueKey, firstIssueValue, _url2;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 2:
              ...
              console.log("paapaa" + contactId);
              _context3.next = 6;
              return client === null || client === void 0 || (_client$request2 = client.request) === null || _client$request2 === void 0 ? void 0 : _client$request2.invokeTemplate("getConvData", {
                context: {
                  userId: contactId,
                  product: "freshchat"
                }
            ...
            case 6:
              ...
              firstIssueKey = Object.keys(issueDataMap)[0]; // Get first issue ID
              firstIssueValue = issueDataMap[firstIssueKey]; // Get first issue description
              _url2 = data.issue_data_list.url;
              console.log(formattedData);
              console.log(response);
              if (!(!response.status === 200)) {
                _context3.next = 18;
            ...
            case 25:
              ...
              console.error("Error fetching ticket details:", _context3.t0);
            case 28:
            case "end":
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    var fetchConvGroupCount = /*#__PURE__*/function () {
      var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        var _client$request3, response, data, formatted;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 4:
              _context4.prev = 4;
              _context4.next = 7;
              return client === null || client === void 0 || (_client$request3 = client.request) === null || _client$request3 === void 0 ? void 0 : _client$request3.invokeTemplate("getConvGroupCount", {
                context: {
                  userId: contactId,
                  product: "freshchat"
                }
            ...
            case 14:
              ...
              console.error("Error fetching ticket details:", _context4.t0);
            case 17:
            case "end":
      ...
      return function fetchConvGroupCount() {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    var fetchTicketGroupCount = /*#__PURE__*/function () {
      var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
        var _client$request4, response, data, formatted;
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 4:
              ...
              _context5.next = 8;
              return client === null || client === void 0 || (_client$request4 = client.request) === null || _client$request4 === void 0 ? void 0 : _client$request4.invokeTemplate("getConvGroupCount", {
                context: {
                  userId: contactId,
                  product: "freshdesk"
                }
            ...
            case 14:
              ...
              console.error("Error fetching ticket details:", _context5.t0);
            case 17:
            case "end":
      ...
      return function fetchTicketGroupCount() {
  ...
  var OrderInfo = function OrderInfo(_ref7) {
    var item = _ref7.item;
  ...
  var handleChartSelection = function handleChartSelection(type, data, typeFrom) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    ...
    onFwChange: function onFwChange(e) {
      return handleChartSelection(e.detail.value, convFreq, "chat");
    }
    ...
    "option-value-path": "id",
    onFwChange: function onFwChange(e) {
      return handleChartSelection(e.detail.value, ticketsFreq, "ticket");
    }
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_freshworks_crayons_react__WEBPACK_IMPORTED_MODULE_5__.FwPopover, {
    ref: topicPopRef,
    "same-width": "false"
    ...
    "option-value-path": "id",
    onFwChange: function onFwChange(e) {
      return handleChartSelection(e.detail.value, chartData, "topic");
    }
...
//# sourceMappingURL=main.a4c32bca.js.map