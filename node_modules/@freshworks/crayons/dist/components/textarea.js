...
import { d as debounce, a as hasSlot, r as renderHiddenField } from './index2.js';
...
const Textarea = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  ...
  static get style() { return textareaCss; }
    ...
    "rows": [2],
    "maxRows": [2, "max-rows"],
    "maxRowsDebounceTimer": [2, "max-rows-debounce-timer"],
    "maxlength": [2],
    "minlength": [2],
    "name": [1],
    "placeholder": [1],
...
export { Textarea as T, defineCustomElement as d };
