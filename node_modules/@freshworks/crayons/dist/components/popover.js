...
const Popover = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement$1 {
  ...
  static get style() { return popoverCss; }
    ...
    "trigger": [1],
    "hasBorder": [4, "has-border"],
    "hoist": [4],
    "disableTransition": [4, "disable-transition"],
    "autoFocusOnContent": [4, "auto-focus-on-content"],
    "hideOnTab": [4, "hide-on-tab"],
    "showAfter": [2, "show-after"],
...
export { Popover as P, createPopper as c, defineCustomElement as d };
