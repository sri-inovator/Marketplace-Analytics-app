...
import { p as popperModifierRTL } from './index2.js';
import { d as defineCustomElement$i } from './avatar.js';
import { d as defineCustomElement$h } from './button.js';
import { d as defineCustomElement$g } from './checkbox.js';
import { d as defineCustomElement$f } from './custom-cell-anchor.js';
import { d as defineCustomElement$e } from './custom-cell-icon.js';
import { d as defineCustomElement$d } from './custom-cell-paragraph.js';
import { d as defineCustomElement$c } from './custom-cell-user.js';
import { d as defineCustomElement$b } from './drag-container.js';
import { d as defineCustomElement$a } from './icon.js';
import { d as defineCustomElement$9 } from './input.js';
import { d as defineCustomElement$8 } from './kebab-menu.js';
import { d as defineCustomElement$7 } from './list-options.js';
import { c as createPopper, d as defineCustomElement$6 } from './popover.js';
...
const DataTable = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return dataTableCss; }
    ...
    "label": [1025],
    "rowActions": [16],
    "showRowActionsAsMenu": [4, "show-row-actions-as-menu"],
    "rowActionsHeaderLabel": [8, "row-actions-header-label"],
    "rowActionsMenuVariant": [1, "row-actions-menu-variant"],
    "rowActionsWidthProperties": [16],
    "rows": [1040],
    "columns": [1040],
    "isSelectable": [4, "is-selectable"],
    "isAllSelectable": [4, "is-all-selectable"],
    "showSettings": [4, "show-settings"],
    "autoSaveSettings": [4, "auto-save-settings"],
    "isLoading": [1540, "is-loading"],
    "shimmerCount": [2, "shimmer-count"],
    "orderedColumns": [32],
    "selected": [32],
    "rowsLoading": [32],
    "columnsDragSetting": [32],
    "columnsHideSetting": [32],
    "isSettingsOpen": [32],
    "settingSearchText": [32],
    "disabledColumnHide": [32],
    "showShimmer": [32],
    "ifAutoCalculatedWidth": [32],
    "selectAllRows": [64],
    "getSelectedRows": [64],
    "getSelectedIds": [64],
    "getTableSettings": [64],
...
function defineCustomElement$1() {
  ...
  const components = ["fw-data-table", "fw-avatar", "fw-button", "fw-checkbox", "fw-custom-cell-anchor", "fw-custom-cell-icon", "fw-custom-cell-paragraph", "fw-custom-cell-user", "fw-drag-container", "fw-icon", "fw-input", "fw-kebab-menu", "fw-list-options", "fw-popover", "fw-select-option", "fw-skeleton", "fw-spinner", "fw-tooltip"];
...
const FwDataTable = DataTable;
const defineCustomElement = defineCustomElement$1;

export { FwDataTable, defineCustomElement };
