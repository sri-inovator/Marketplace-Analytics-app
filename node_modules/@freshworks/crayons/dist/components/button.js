...
import { t as throttle, a as hasSlot } from './index2.js';
...
const Button = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  ...
  static get style() { return buttonCss; }
    ...
    "disabled": [516],
    "loading": [4],
    "showCaretIcon": [4, "show-caret-icon"],
    "modalTriggerId": [1, "modal-trigger-id"],
    "fileUploaderId": [1, "file-uploader-id"],
    "throttleDelay": [2, "throttle-delay"],
    "hasLabel": [32],
    "hasBeforeLabel": [32],
    "hasAfterLabel": [32],
    "setFocus": [64]
...
function defineCustomElement() {
  ...
  const components = ["fw-button", "fw-icon", "fw-spinner"];
