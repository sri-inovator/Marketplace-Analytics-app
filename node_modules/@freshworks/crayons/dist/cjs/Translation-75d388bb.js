...
function __variableDynamicImportRuntime0__(path) {
  switch (path) {
    case '../i18n/ar-SA.json': return Promise.resolve().then(function () { return require('./ar-SA-56039342-c72c4d53.js'); });
    case '../i18n/bg-BG.json': return Promise.resolve().then(function () { return require('./bg-BG-64a6dc17-f1acd6f0.js'); });
    case '../i18n/bs-BA.json': return Promise.resolve().then(function () { return require('./bs-BA-bee10b67-68d0d058.js'); });
    case '../i18n/ca-ES.json': return Promise.resolve().then(function () { return require('./ca-ES-2032b2e4-4d1cfffb.js'); });
    case '../i18n/cs-CZ.json': return Promise.resolve().then(function () { return require('./cs-CZ-7aa43d84-3ef94ac6.js'); });
    case '../i18n/da-DK.json': return Promise.resolve().then(function () { return require('./da-DK-840c6214-dbcf92bf.js'); });
    case '../i18n/de-DE.json': return Promise.resolve().then(function () { return require('./de-DE-fc70cf48-44dc2f73.js'); });
    case '../i18n/el-GR.json': return Promise.resolve().then(function () { return require('./el-GR-cd6a2475-305f407b.js'); });
    case '../i18n/en-US.json': return Promise.resolve().then(function () { return require('./en-US-01a51791-cc45a18e.js'); });
    case '../i18n/es-ES.json': return Promise.resolve().then(function () { return require('./es-ES-b8b7052b-7a372a31.js'); });
    case '../i18n/es-MX.json': return Promise.resolve().then(function () { return require('./es-MX-b3b5dc27-b0307237.js'); });
    case '../i18n/et-EE.json': return Promise.resolve().then(function () { return require('./et-EE-77c3b084-a856bd1f.js'); });
    case '../i18n/fi-FI.json': return Promise.resolve().then(function () { return require('./fi-FI-a48f5463-bcc9e6c6.js'); });
    case '../i18n/fil-PH.json': return Promise.resolve().then(function () { return require('./fil-PH-d5a216a4-d5908f9b.js'); });
    case '../i18n/fr-FR.json': return Promise.resolve().then(function () { return require('./fr-FR-ab3cccc4-b0e0f394.js'); });
    case '../i18n/he-IL.json': return Promise.resolve().then(function () { return require('./he-IL-e5ad8fff-5b4d86dd.js'); });
    case '../i18n/hr-HR.json': return Promise.resolve().then(function () { return require('./hr-HR-4d0dbf47-af3b4ca4.js'); });
    case '../i18n/hu-HU.json': return Promise.resolve().then(function () { return require('./hu-HU-61ee6419-1089d400.js'); });
    case '../i18n/id-ID.json': return Promise.resolve().then(function () { return require('./id-ID-e45f6c50-5e3722b6.js'); });
    case '../i18n/is-IS.json': return Promise.resolve().then(function () { return require('./is-IS-3c0ffb82-3a0e90f9.js'); });
    case '../i18n/it-IT.json': return Promise.resolve().then(function () { return require('./it-IT-78f8008f-42f6d25c.js'); });
    case '../i18n/ja-JP.json': return Promise.resolve().then(function () { return require('./ja-JP-aa615c3a-92d9c153.js'); });
    case '../i18n/ko-KR.json': return Promise.resolve().then(function () { return require('./ko-KR-b8df8091-58384861.js'); });
    case '../i18n/lt-LT.json': return Promise.resolve().then(function () { return require('./lt-LT-5cc0a640-ee3fd6a2.js'); });
    case '../i18n/lv-LV.json': return Promise.resolve().then(function () { return require('./lv-LV-e0eaf357-26be1504.js'); });
    case '../i18n/nl-NL.json': return Promise.resolve().then(function () { return require('./nl-NL-61ed02ff-8b58b1a2.js'); });
    case '../i18n/no-NO.json': return Promise.resolve().then(function () { return require('./no-NO-51b99926-7e7b8922.js'); });
    case '../i18n/pl-PL.json': return Promise.resolve().then(function () { return require('./pl-PL-58543d63-036adbaf.js'); });
    case '../i18n/pt-BR.json': return Promise.resolve().then(function () { return require('./pt-BR-edd1b286-e1dd1c33.js'); });
    case '../i18n/pt-PT.json': return Promise.resolve().then(function () { return require('./pt-PT-ad30b002-87634307.js'); });
    case '../i18n/ro-RO.json': return Promise.resolve().then(function () { return require('./ro-RO-f74ec8b4-806cf6f2.js'); });
    case '../i18n/ru-RU.json': return Promise.resolve().then(function () { return require('./ru-RU-33dbfcc1-3e65db7a.js'); });
    case '../i18n/sk-SK.json': return Promise.resolve().then(function () { return require('./sk-SK-5d7c5cdf-0417b7c0.js'); });
    case '../i18n/sl-SI.json': return Promise.resolve().then(function () { return require('./sl-SI-96c4114f-ff2928d0.js'); });
    case '../i18n/sr-SP.json': return Promise.resolve().then(function () { return require('./sr-SP-f44b39bf-b4e761cd.js'); });
    case '../i18n/sv-SE.json': return Promise.resolve().then(function () { return require('./sv-SE-c313bf14-2739f197.js'); });
    case '../i18n/th-TH.json': return Promise.resolve().then(function () { return require('./th-TH-abad6bea-2ca59870.js'); });
    case '../i18n/tr-TR.json': return Promise.resolve().then(function () { return require('./tr-TR-956b2b92-5abd7a50.js'); });
    case '../i18n/uk-UA.json': return Promise.resolve().then(function () { return require('./uk-UA-2643eea5-b7742efe.js'); });
    case '../i18n/vi-VN.json': return Promise.resolve().then(function () { return require('./vi-VN-5ee4b2ad-14f8624f.js'); });
    case '../i18n/zh-CN.json': return Promise.resolve().then(function () { return require('./zh-CN-d42aa636-111bc756.js'); });
    case '../i18n/zh-TW.json': return Promise.resolve().then(function () { return require('./zh-TW-bb971a99-a8921668.js'); });
    default: return new Promise(function(resolve, reject) {
      (typeof queueMicrotask === 'function' ? queueMicrotask : setTimeout)(
        reject.bind(null, new Error("Unknown variable dynamic import: " + path))
      );
