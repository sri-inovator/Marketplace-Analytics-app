...
const patchBrowser = () => {
    ...
    }
    {
        ...
        if (!index.win.customElements) {
            ...
            // @ts-ignore
            return Promise.resolve().then(function () { return require(/* webpackChunkName: "polyfills-dom" */ './dom-d5e52c7e.js'); }).then(() => opts);
        }
    }
