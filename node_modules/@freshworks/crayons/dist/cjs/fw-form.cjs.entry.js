...
var _cloneBuffer = _commonjsHelpers.createCommonjsModule(function (module, exports) {
/** Detect free variable `exports`. */
var freeExports = exports && !exports.nodeType && exports;
...
const translateErrors = async (errors = {}, fields) => {
  ...
  return (_a = Object.keys(errors)) === null || _a === void 0 ? void 0 : _a.reduce((acc, key) => {
    var _a, _b;
    if (key && errors[key]) {
      return Object.assign(Object.assign({}, acc), { [key]: Translation.TranslationController.t(errors[key], {
...
const Form = class {
  constructor(hostRef) {
    ...
    this.fwFormValuesChanged = index.createEvent(this, "fwFormValuesChanged", 7);
    this.fwFormValueChanged = index.createEvent(this, "fwFormValueChanged", 7);
    /**
  ...
  async componentWillLoad() {
    this.debouncedHandleInput = index$1.debounce(this.handleInput, this, this.wait);
  ...
  render() {
    ...
    return (index.h("form", Object.assign({ id: `form-${this.formId}` }, utils.formProps), this.formSchemaState &&
