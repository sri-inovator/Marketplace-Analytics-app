...
const FileUploaderFile = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.fwRemoveFile = index.createEvent(this, "fwRemoveFile", 7);
    /**
     * file Id
     */
    this.fileId = null;
  ...
  render() {
    ...
    return (index.h("div", { class: 'files-content' }, index.h("div", { class: 'files-content-icon' }, index.h("fw-icon", { name: 'checkbox', size: 14, color: '#00a886' })), index.h("div", { class: 'files-content-file' }, index.h("span", { class: 'files-content-file-name' }, this.name), index.h("button", { class: 'files-content-file-remove', onClick: () => this.remove() }, Translation.TranslationController.t('fileUploader.remove')))));
  }
};
...
const FileUploaderProgress = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.fwRetryUpload = index.createEvent(this, "fwRetryUpload", 7);
    /**
     * file name
     */
    this.fileName = '';
