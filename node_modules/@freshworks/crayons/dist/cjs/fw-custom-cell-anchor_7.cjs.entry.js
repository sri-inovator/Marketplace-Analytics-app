...
class Draggable {
  constructor(container, options) {
    ...
    this.acceptFrom = [];
    this.dropped = false;
    this.debouncedSetElement = index$1.debounce((childElements, draggingElement, y) => {
      ...
      if (this.placeholder) {
        if (this.options.addOnDrop) {
          const clone = this.options.copy
            ? index$1.cloneNodeWithEvents(dragElement, true, true)
            : dragElement;
...
const DragContainer = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.fwDrop = index.createEvent(this, "fwDrop", 7);
    /**
  ...
  render() {
    return index.h(index.Host, { class: 'drag-container' });
  }
...
exports.fw_drag_container = DragContainer;
