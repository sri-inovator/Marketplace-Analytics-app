<!doctype html><html dir="ltr" lang="en"><head> <meta charset="utf-8"> <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=5.0"> <title>Stencil Component Starter</title> <link rel="modulepreload" href="/build/p-38b3cd66.js"><script type="module" src="/build/p-38b3cd66.js" data-stencil data-resources-url="/build/" data-stencil-namespace="crayons"></script> <script nomodule="" src="/build/crayons.js" data-stencil></script> </head> <body> <!-- <fw-button expand color="primary">Primary Button</fw-button> --> <!-- start of form examples dynamic and static forms --> <!-- <div style="display: flex; justify-content: space-around">
    <div id="dynamic-form-container">
        <h3>Dynamic form via `formSchema`</h3>
        <fw-input
          search
          id="inp"
          placeholder="Type to filter form fields below"
        ></fw-input>
        ...
        <script>
          ...
          document.querySelector('#inp').addEventListener('fwInput', (e) => {
            form.setFieldSearchText(e.detail.value);
          });
          document
          ...
          form.mapperType = 'FORMSERV'; // LEGO | FORMSERV | CUSTOM

          if (form.mapperType === 'FORMSERV') form.formSchema = formServSchema;
          else if (form.mapperType === 'CUSTOM') {
            form.formSchema = formSchemaCustom;
            var customTypeMapper = {
              CUSTOM_DROPDOWN: { type: 'DROPDOWN' },
              CUSTOM_DATE: { type: 'DATE' },
            };
            form.customTypeMapper = customTypeMapper;
          } else form.formSchema = formSchema; // default LEGO mapper type.

          form.initialValues = initialValues;
        </script>
      </div> --> <!-- <div id="static-form-container">
        <h3>Static form via `fw-form-control` slots</h3>
        <fw-input
          search
          id="inp1"
          placeholder="Type to filter form fields below"
      ...
      <script type="application/javascript">
        ...
        document.querySelector('#inp1').addEventListener('fwInput', (e) => {
          formStatic.setFieldSearchText(e.detail.value);
        });
        document
          ...
          .addEventListener('click', async (e) => {
            ...
            if (isValid) {
              ...
              formStatic.setFieldErrors({
                cin: 'First Name must be unique <!Server Error>>',
              });
              // reset the form if required if success
              // formRef.current.doReset(e);
            }
        ...
        var initialValuesStaticForm = {
          first_name: 'John',
          cin: 'test@gmail.com',
          chk: true,
        };
        formStatic.initialValues = initialValuesStaticForm;
        // formStatic.validate = async function (values) {
        //   console.log('validate method called with ', values);
        //   return {
        //     // first_name: 'first name error',
        //     // last_name: 'last name error',
        //     // first_name: 'ss error validate function prop',
        //   };
        //   // json api std.
        // };
        ...
        function handleChkChange(e) {
          console.log('handle custom chk');
          formStatic.setFieldValue([e.target.name], e.target.checked);
        }
        document
          .querySelector('#chk')
          .addEventListener('change', handleChkChange);
        document
          .querySelector('#cin')
    ...
    </div> --> <!-- end of form examples static and dynamic form --> <!-- <br />
    <fw-radio-group
      name="Profile"
      value="au"
...
--> <!-- <div style="display: flex; align-items: center; justify-content: center;">
    ...
    datatable1.rows = data1.rows;
      ...
      max-file-size="5"
    >
  </fw-file-uploader> --> <!-- <script>
    window.addEventListener('fwInput', eventHandler);
    window.addEventListener('fwBlur', eventHandler);
    function eventHandler(e) {
      console.log('action link clicked', e);
    }
  </script>
  ...
  ></fw-country-phone> --> <!-- <div>
    <fw-file-uploader-2
        ...
        hide-label="false"
        restrict-attachment-width="true"
        style="--max-attachment-block-height: 80px;"
      >
    </fw-file-uploader-2>
  ...
  </div> --> <!-- File uploader as part of form
  ...
  <script type="application/javascript">
    ...
    var formSchema = {
      ...
      fields: [
        ...
        {
          name: 'profile_pic_simple',
          type: 'FILES',
          position: 3,
          required: true,
          placeholder: '',
          simpleInterfaceForSingleMode: true,
          maxFileSize: 0.008
        }
      ]
    };
  ...
  </script> --> <script data-build="2023-07-05T04:09:35">
